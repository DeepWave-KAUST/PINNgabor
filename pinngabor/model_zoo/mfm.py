...
import numpy as np
'''
based on https://github.com/boschresearch/multiplicative-filter-networks
'''
...
class MFNBase(nn.Module):
    ...
    a nn.ModuleList of n_layers+1 filters with output equal to hidden_size. borrowed from       
    """
...
class GaborLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, weight_scale, alpha=1.0, beta=1.0):
        ...
        self.gamma = nn.Parameter(
            0.25 * torch.distributions.gamma.Gamma(alpha, beta).sample((out_features,))
        )
